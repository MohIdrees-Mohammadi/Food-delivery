...
const contact = () => {
  return (
    <section className="h-full flex flex-col items-center  bg-forbackround">
      <div className="flex h-[20vh] mt-[2%] flex-col gap-2 items-center ">
      ...
      <div className="flex  w-full flex-col lg:flex-row items-center justify-evenly px-5 gap-3 py-2">
        <div className="flex flex-col h-[60vh] items-center justify-evenly  w-[90%] lg:w-[45%]">
        ...
        <div
          className="w-[90vw] h-[50vh] lg:w-[45%] lg:h-[60vh]"
        >
          <iframe
            ...
            className=" h-full w-full rounded-2xl py-0 "
